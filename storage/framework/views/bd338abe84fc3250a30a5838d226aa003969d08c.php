    ...
    <div class="h-screen flex justify-center items-center">
        <div class="container mx-2 shadow-md lg:w-2/4 lg:mx-0 p-4">
            ...
            <form method="post" action="/update" class="w-full">
                ...
                <input type="hidden" name="id" value="<?php echo e($contents['data']['id']); ?>">
                <input type="text" name="nama" class="mt-1 mb-2" value="<?php echo e($contents['data']['name']); ?>"><br>
                <label for="deskripsi">Deskripsi</label><br>
                <textarea name="deskripsi" rows="3" class="mt-1 mb-2"><?php echo e($contents['data']['description']); ?></textarea><br>
                <label for="harga">Harga</label><br>
                <input type="number" name="harga" class="mt-1 mb-2" value="<?php echo e($contents['data']['price']); ?>"><br>
...
</html><?php /**PATH C:\xampp\htdocs\e-commerce\resources\views/update.blade.php ENDPATH**/ ?>